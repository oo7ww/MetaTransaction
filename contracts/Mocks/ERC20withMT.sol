 ...
 */
contract ERC20withMT is IERC20, MinterRole {
    ...
    */
    ...
    function metaApprove(
        ...
        replayNonce[signer]++;
        _allowances[signer][spender] = _allowances[signer][spender].add(value);
        if (reward > 0) {
    ...
    function metaApproveHash(
        ...
        return
            keccak256(
                abi.encodePacked(address(this), spender, value, nonce, reward)
            );
    }
